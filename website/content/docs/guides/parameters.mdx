...
| `extraction_method` | `Literal["mc","dc","surfnets","manifold"]` | `"mc"` | `--extraction-method` | Extraction algorithm. SDF smart default: `"dc"`. DC/surfnets auto-set bilateral smoothing with 5 iterations |
