...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
  <div>
    <p className="text-center font-semibold mb-2">Marching Cubes (72K verts)</p>
    <MeshViewer src="/models/bunny_mc.stl" height={400} cameraDistance={80} fov={35} />
  </div>
  <div>
    <p className="text-center font-semibold mb-2">Dual Contouring (69K verts)</p>
    <MeshViewer src="/models/bunny_dc.stl" height={400} cameraDistance={80} fov={35} />
  </div>
</div>
