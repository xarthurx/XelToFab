...
<img src="/images/guides/extraction-gradient-quality.png" alt="DC with noisy EDT SDF (left, rough surface) vs DC with true signed distance (right, clean surface)" width={800} />

**Recommendation:** If your SDF comes from a binary voxelization or distance transform, use `surfnets` (robust averaging) or `mc` instead of `dc`. For neural SDF models, see the [SDF Functions guide](/docs/guides/sdf-functions#best-practices-for-neural-sdfs) for extraction method selection advice.
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
  <div>
    <p className="text-center font-semibold mb-2">Marching Cubes (15.5K verts)</p>
    <MeshViewer src="/models/bunny_mc.stl" height={400} cameraDistance={55} fov={35} />
  </div>
  <div>
    <p className="text-center font-semibold mb-2">Dual Contouring (15.4K verts)</p>
    <MeshViewer src="/models/bunny_dc.stl" height={400} cameraDistance={55} fov={35} />
  </div>
</div>
