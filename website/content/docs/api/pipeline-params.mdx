...
|-------|------|---------|-------------|-------------|
| `threshold` | `float` | `0.5` | `>= 0.0`, `<= 1.0` | Density threshold for binarization |
...
```python
from xeltofab import PipelineParams, load_density

# Default parameters
params = PipelineParams()

# Custom parameters for a density field
params = PipelineParams(
    threshold=0.4,
    smooth_sigma=1.5,
...
# Pass to load_density
state = load_density("field.npy", params=params)
```
