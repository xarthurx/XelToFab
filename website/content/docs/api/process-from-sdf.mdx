...
<Cards>
  <Card title="SDF Functions Guide" description="When to use, wrapping models, uniform vs adaptive" href="/docs/guides/sdf-functions" />
  <Card title="process()" description="For pre-evaluated numpy grid fields" href="/docs/api/process" />
