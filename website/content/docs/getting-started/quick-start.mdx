...
This evaluates the function on a uniform grid internally, then runs the full pipeline. Works with any SDF source — PyTorch models, ONNX, analytical formulas. See [`process_from_sdf`](/docs/api/process-from-sdf) for details.
